...
mysql_query('CREATE database aaa_wish2');
mysql_select_db('aaa_wish2');
...
switch($act){
	case 'add':
		...
		$i_sql="INSERT INTO  `aaa_wish2`.`wish` (`ID` ,`username` ,`content`,`time`) VALUES (NULL ,  '".$username."',  '".$content."',".time().")";
		mysql_query($i_sql);
